...
\begin{figure}[H]
    \centering
    \shadowbox{\includegraphics[width=0.8\textwidth]{pictures/Curvas_entrenamiento_keras.png}}
...
\begin{figure}[H]
    \centering
    \shadowbox{\includegraphics[width=0.7\textwidth]{pictures/Matriz_confusion_pytorch.png}}
