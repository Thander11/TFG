...
\begin{itemize}
    ...
    \item \textbf{Desarrollo de un sistema bastado de deteción en narices electrónicas:} Creación de un sistema completo que incluye la recolección de datos, el desarrollo de modelos de aprendizaje automático y la implementación de una interfaz móvil para facilitar su uso en el exterior.
