...
Para este proyecto se ha decidio usar Python como lenguaje de programación debido a sus fentajas, especialmente por ser el mas usado para el entrenamiento de modelos de inteligencia artificial y el gran soporte de la comunidad. En cuanto al entorno de ejecución, se ha optado por Google Colab, ya que proporciona acceso gratuito a GPUs y TPUs, facilitando el entrenamiento de modelos complejos sin necesidad de contar con hardware potente localmente y pudiendo guardar los notebooks, modelos y datasets directamente en Google Drive\@. Finalmente se han elegido tanto PyTorch como Keras como frameworks para el desarrollo y entrenamiento de la ANN\@. Se entrenarán modelos con ambos frameworks y los mismos datos para comparar resultados y determinar cuál se adapta mejor a las necesidades del proyecto.

\subsubsection{Aplicación Bluetooth}
En lo relativo a la construcción de la aplicación móvil responsable de la comunicación Bluetooth con la nariz electrónica, se han evaluado diversas alternativas tecnológicas:
