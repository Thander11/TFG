...
% Definir color azul clarito para cabeceras
...
\endgroup
  ...
  \begin{tabularx}{\textwidth}{@{}p{4.5cm} p{3.2cm} X@{}}
    \toprule
    	\cellcolor{lightblue}\textbf{Fase} & \cellcolor{lightblue}\textbf{Fechas} & \cellcolor{lightblue}\textbf{Actividades} \\
    \midrule
    ...
    3. Formación y entrenamiento de la nariz electrónica
      ...
      & \begin{minipage}[t]{\linewidth}
          \begin{itemize}
            \item 5/12 Reunión con Jesús Lozano Rogado.
            \item Formación con Jesús Lozano Rogado.
            \item Entrenamiento de la nariz electrónica.
            \begin{itemize}
              \item Crear dataset.
              \item Limpiar dataset.
              \item Entrenar red neuronal.
              \item Crear aplicación Bluetooth.
            \end{itemize}
          \end{itemize}
        \end{minipage} \\
