...
\begingroup
\begin{center}
	{\LARGE \textbf{Estudio de viabilidad de una Nariz Electrónica como herramienta de apoyo para los Agentes Caninos}\par}
	\vspace{1em}
...
Desarrollar una nariz electrónica capaz de detectar un tipo de  sustancias y compararla con el olfato de los agentes caninos entrenados del cuerpo de detección de sustancias de la Guardia Civil.
...
\begin{itemize}
	...
	\item Formación y entrenamiento de la nariz electrónica para la detección de una sustancia.
	\item Comparación de la nariz electrónica con el olfato de los agentes caninos entrenados del cuerpo de detección de sustancias de la Guardia Civil.
\end{itemize}
...
Tras la finalización del proyecto se espera obtener una nariz electrónica capaz de detectar un tipo de sustancia y que su rendimiento sea comparable al de los agentes caninos entrenados del cuerpo de detección de sustancias de la Guardia Civil de.
